...
public class DebitCard {
    ...
    */
    ...
    public DebitCard(long cardNumber, String holderName, double balance){
        this.holderName = holderName; // instance to the class
    ...
    public DebitCard(long cardNumber, String holderName, String cardType, int pin, double balance) { // we made a method here
