...
public class Groups {
    public static void main(String[] args) {
        ...
        for (String[] innerArray : cydeo) { // loops through the 2D array, cydeo (array element)

            for (String eachWord : innerArray) { // loops through every String element in each 1D inner array (string element)
