...
public class RecapVariables {
    ...
    // We can't print the variables because they don't have the value
...
//        System.out.println(totalStudentInClass);
        ...
        System.out.println(numberOfCoffeeCups + " * " + totalStudentInClass); //we used concatenation to values of two variables at the time
