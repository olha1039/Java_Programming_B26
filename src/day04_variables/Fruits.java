...
public class Fruits {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The price of my 25 apples is $20"); // 25 is hard coded, it can't change

        int price = 15;

        System.out.println("The price of my " + apples + " apples is $" + price); // variables added
