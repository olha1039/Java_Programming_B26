...
Output: No palindrome
        ...
        System.out.println(longestPalindrome.isEmpty() ? "NoPalindrome" : longestPalindrome);


        /* civic
        (eachWord.charAt(i) != eachWord.charAt(eachWord.length() - 1 - i))
        int i = 0;
        eachWord.charAt(i) != eachWord.charAt(eachWord.length(5) - 1 - 0 --> charAt(4)
            c != c
        i = 1
        eachWord.charAt(i) != eachWord.charAt(eachWord.length(5) - 1 - 1 --> charAt(3)
            i != i
         */
