...
public class CamelCase {
    ...
    public static void main(String[] args) {
        ...
        String camelCase = str.substring(0, 1); //I'm putting the first character into the string right away, because my loop will start from i=1. It starts from i=1 because I am doing i - 1 check for spaces and I don't want to do this in iteration
