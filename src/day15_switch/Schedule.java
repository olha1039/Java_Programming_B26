...
public class Schedule {
    public static void main(String[] args) {
        ...
        show if there is office hours
            ...
            challenge:
                make each day flexible (monday, Monday, mon)
         */
        ...
        switch (day) {
            ...
            case "tuesday":
            case "wednesday":
                information = "We have Java with Saim at 7 pm EST, but we also have office hours";
                break;
            case "thursday":
            ...
            case "saturday":
            case "sunday":
                information = "We have full day of Java with Saim at 10 am est to 5 pm est";
                break;
            default:
