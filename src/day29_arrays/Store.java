...
public class Store {
    public static void main(String[] args) {
        ...
        int indexOfGroves = -1; // we set -1 as default, so that if gloves is not found in the array it will always give -1
        for (int i = 0; i < items.length; i++) {
        ...
        System.out.println("Index of gloves is: " + indexOfGroves);
