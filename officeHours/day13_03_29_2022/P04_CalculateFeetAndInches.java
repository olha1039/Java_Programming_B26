...
public class P04_CalculateFeetAndInches {
    ...
    public static void main(String[] args) {
        System.out.println(calcFeetAndInches(5, 10));
        System.out.println(calcFeetAndInches(70));
    ...
    public static double calcFeetAndInches(double feet, double inches) {
        ...
        double cm = ((feet * 12) + inches) * 2.54; //return
